...
function disableShoutButton(form) {
  var input = form.querySelector('#shout-input');
  var button = form.querySelector('#shout-submit');
  if (input) {
...
exports.default = disableShoutButton;
...
function attachDropdownToButton(button, dropdown) {
  button.addEventListener('click', function (e) {
    ...
    var current = document.querySelector('.dropdown__menu--active');
...
function ajaxLike(e) {
  ...
  _axios2.default.post(this.dataset.action).then(function (res) {
    // toggle active class and set users followers to match the data sent back
    _this.classList.toggle('shout-card__control-item--active');
    var element = _this.querySelector('.shout-card__control-item--value');
    ...
    if (!isNaN(Number(element.textContent)) || element.textContent === '') {
      if (![].concat(_toConsumableArray(_this.classList)).includes('shout-card__control-item--active')) {
...
var _disableButton = __webpack_require__(10);

var _disableButton2 = _interopRequireDefault(_disableButton);

var _dropdowns = __webpack_require__(11);
...
var _likeshout = __webpack_require__(14);

var _likeshout2 = _interopRequireDefault(_likeshout);
...
(0, _bling.$$)('.shout-form').forEach(_disableButton2.default);
(0, _dropdowns2.default)((0, _bling.$$)('.dropdown'));
(0, _bling.$$)('.follow-form').on('submit', _follow2.default);
(0, _bling.$$)('.shout-card__likes').on('click', _likeshout2.default);
(0, _lightbox2.default)((0, _bling.$)('#shout-form-btn'), (0, _bling.$)('#shout-form-screen'));
